...
(function() {
  ...
  var Resizer = function(image) {
    ...
    this._image.onload = function() {
      this._container.width = parseInt(this._image.naturalWidth,10);
      this._container.height = parseInt(this._image.naturalHeight,10);
      ...
      var side = Math.min(
          parseInt(this._container.width * INITIAL_SIDE_RATIO,10),
          parseInt(this._container.height * INITIAL_SIDE_RATIO,10));
  ...
  Resizer.prototype = {
    ...
    exportImage: function() {
      ...
      imageToExport.src = temporaryCanvas.toDataURL('image/jpeg');
